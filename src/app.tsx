...
export function App() {
	return (<>
		...
		<TabbedPane>
			...
			<Tab id={ 'log' } title={ 'Log Formatter (legacy)' } keybind={ 'l' } localStorageGate={ 'log:antlr' } gateInverted>
				<LogFormatter/>
			</Tab>
			<Tab id={ 'antlr' } title={ 'Log Formatter' } keybind={ 'a' } localStorageGate={ 'log:antlr' }>
				<LogAntlrFormatter/>
			</Tab>
		</TabbedPane>
	</>)
